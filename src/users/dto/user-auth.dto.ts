...
export class UserAuthInstanceDto {
    @ApiProperty({
        example: 'eyJhbGciOi1NiIsInR5cCIVCJ9.eyJpZCITUsIm5hbWUiOiLQodC10LzQtdC9IiwiZW1haWwiOiJ1c2VyQYWlsLnJ1Ii9sZXMiOnsiaWQiOjMsInZhbHVlIjoidXNlciIsImRlc2NyaXB0aW9uIjoi0J_QvtC70YzQt9C-0LLQsNGC0LXQu9GMIiwiY3JlYXRlZEF0IjoiMjAyMi0xMC0xOVQxNjowNjowNi45NjlaIiwidXBkYXRlZEF0IjoiMjAyMi0xMC0yMFQxMzoxNjoxMC4xOThaIn0sImlhdCI6MTY2NjY5MTAxOCwiZXhwIjoxNjY2Nzc3NDE4fQ.1i_WC_pfx_kb7ljN4hnVGrrnr2eWB_Tv6AiJ4QHq',
        description: 'Access-токен'}
    )
    accessToken: string;

    @ApiProperty({
        example: '1i_WC_pfx_kb7ljN4hnVGrrnr2eWB_Tv6AiJ4QHq',
